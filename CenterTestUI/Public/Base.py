...
class Base(object):
	...
	def find_element(self, *loc):
		...
		try:
			...
			raise Exception ("Can't find element as %s " % loc)
	...
	def insert_img(self, file_name):
		"""截图保存"""
		file_path = self.basedir + os.sep +"report" + os.sep + "image" + os.sep + file_name
	...
	def addfile(self, windowname, filename):
		...
		if autoit.win_exists(windowname):
			...
			APPLICATION_PATH = self.basedir + os.sep + 'data' + os.sep +'uploadfile'
